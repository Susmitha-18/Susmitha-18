...
&#x20; <strong>Computer Science \& Engineering Student · Full-Stack Development · Cloud \& DevOps</strong>
...
\### 🚛 Heavy Vehicle Management System — HVMS
...
\*\*Technologies:\*\* MERN · MongoDB Atlas · REST APIs · Render
...
\*\*Technologies:\*\* Terraform · Jenkins · GitHub Actions · AWS EC2 · Docker · Nginx · MongoDB
...
\### ✈️ Ultra Travel — AI-Powered Travel Platform
...
\*\*Technologies:\*\* MERN · TypeScript · REST APIs · Database Integration
...
\### 📱 Venba Farms Mobile Application
...
\- \*\*Sign Language Recognition\*\* — Real-time gesture detection using Machine Learning and Computer Vision
